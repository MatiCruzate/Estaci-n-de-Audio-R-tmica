...
/*
	switch(caso)
	{
	case 0: HAL_GPIO_TogglePin(GPIOD, LD4_Pin);
	break;
	case 1: 	HAL_GPIO_TogglePin(GPIOD, LD5_Pin);
	break;
	case 2: 	HAL_GPIO_TogglePin(GPIOD, LD6_Pin);
	break;
	case 3: 	HAL_GPIO_TogglePin(GPIOD, LD3_Pin);
	break;
	}
	caso = (caso+1)%4;
	*/
